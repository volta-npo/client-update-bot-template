# Security Policy: Client Update Bot Template
...
- For this product's domain, review these gates before handoff: Next step and owner ask required, Risk level required, Reviewer required before sending.
