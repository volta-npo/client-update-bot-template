export const v3 = {
  "productName": "Client Update Bot Template",
  "productTier": "release",
  ...
  "capabilities": [
    "Domain-specific workbench: Weekly Client Update Builder",
    "Operational table: Project status items",
  ...
  "releaseChecklist": [
    ...
    "Update Completeness reaches production threshold",
    "On-time Cadence is documented with evidence",
    "Risk Clarity has no unresolved blocker",
    "Email update verified",
    "Slack-style update verified",
    "Timeline CSV verified"
  ],
  "operations": [
